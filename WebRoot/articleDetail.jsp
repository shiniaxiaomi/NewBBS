...
<div id="jive-flatpage">
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr valign="top">
        <td width="99%"><p class="jive-breadcrumbs"> <a href="article.jsp">返回首页</a></p>
    ...
    <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          ...
          <td class="jive-icon-label"><a id="jive-reply-thread" href="reply.jsp?id=<%=a.getId() %>&rootid=<%=a.getRootid() %>&replyType=tree">回复本主题</a> </td>
        </tr>
      </tbody>
    </table>
  </div>
